  ...
  <AdminLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Doctor</h2>
        ...
        <div class="p-6">
          <form @submit.prevent="submit">
            <div class="space-y-6">
              ...
              <div v-else-if="doctor.image" class="mt-4">
                <img :src="`/storage/${doctor.image}`" alt="Current image" class="object-cover h-40 w-40 rounded-lg" />
              </div>
...
const form = useForm({
  ...
  hospital_id: props.doctor.hospital_id || '',
