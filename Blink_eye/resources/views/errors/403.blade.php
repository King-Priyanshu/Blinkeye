...
<head>
    ...
    <title>Access Forbidden - Blink Eye Hospitals</title>
...
<body class="font-sans antialiased bg-gray-50 min-h-screen">
    ...
    <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            <!-- Error Icon -->
            <div class="relative">
                <div class="absolute -inset-4 bg-red-100 rounded-full opacity-50 blur-xl"></div>
                <div class="relative bg-white p-6 rounded-full shadow-lg border border-red-100">
            ...
            <!-- Error Code -->
            <h1 class="mt-8 text-6xl font-extrabold text-gray-900 tracking-tight">403</h1>

            <!-- Title -->
            <h2 class="mt-4 text-2xl font-bold text-gray-900">Access Forbidden</h2>
            ...
            <p class="mt-3 text-gray-600">
                ...
                {{ $message }}
                @else
                You don't have permission to access this page. Please contact the administrator if you believe this is
                an error.
                @endisset
            </p>
