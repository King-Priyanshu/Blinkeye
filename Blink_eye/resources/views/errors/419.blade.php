...
<head>
    ...
    <title>Session Expired - Blink Eye Hospitals</title>
...
<body class="font-sans antialiased bg-gray-50 min-h-screen">
    ...
    <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            <!-- Error Icon -->
            <div class="relative">
                <div class="absolute -inset-4 bg-orange-100 rounded-full opacity-50 blur-xl"></div>
            ...
            <!-- Error Code -->
            <h1 class="mt-8 text-6xl font-extrabold text-gray-900 tracking-tight">419</h1>

            <!-- Title -->
            <h2 class="mt-4 text-2xl font-bold text-gray-900">Session Expired</h2>

            <!-- Message -->
            <p class="mt-3 text-gray-600">
                Your session has expired due to inactivity. This could be because:
            </p>
            ...
            <div class="mt-4 p-4 bg-gray-50 rounded-lg text-left">
                <ul class="list-disc list-inside text-sm text-gray-600 space-y-2">
                    ...
                    <li>You closed your browser tab</li>
                    <li>Browser cookies were cleared</li>
                    <li>You submitted a form after the session expired</li>
                </ul>
            </div>
            ...
            <p class="mt-6 text-sm text-gray-500">
                If you were filling out a form, please try again after refreshing the page.
            </p>
        </div>
    </div>
