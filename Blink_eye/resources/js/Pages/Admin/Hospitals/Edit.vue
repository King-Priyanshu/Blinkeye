...
const props = defineProps({
    ...
    selectedDiseaseIds: Array,
    selectedGroupIds: Array,
    selectedBlogIds: Array,
    ...
    <AdminLayout>
        ...
        <div class="mb-8 relative rounded-2xl p-8 overflow-hidden shadow-lg bg-gradient-to-r from-slate-900 to-slate-800 border border-slate-700">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-300 tracking-tight">Edit Branch: {{ props.hospital.name }}</h1>
                <p class="mt-2 text-sm text-slate-400 font-medium">Update presence and configuration for this hospital branch.</p>
            </div>
        </div>
