...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Edit Clinical Service" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="sm:flex sm:items-center"${_scopeId}><div class="sm:flex-auto"${_scopeId}><h1 class="text-base font-semibold leading-6 text-gray-900"${_scopeId}>Edit Service: ${ssrInterpolate(__props.service.name)}</h1></div><div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex items-center space-x-4"${_scopeId}>`);
            ...
            } else if (__props.service.image) {
              _push2(`<img${ssrRenderAttr("src", `/storage/${__props.service.image}`)} alt="Current Image" class="h-16 w-16 object-cover rounded-md shadow-sm"${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="inline-flex justify-center rounded-md bg-medical-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-medical-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-medical-blue-600"${_scopeId}> Update Service </button></div></form></div></div>`);
          } else {
            return [
              createVNode("div", { class: "sm:flex sm:items-center" }, [
                createVNode("div", { class: "sm:flex-auto" }, [
                  createVNode("h1", { class: "text-base font-semibold leading-6 text-gray-900" }, "Edit Service: " + toDisplayString(__props.service.name), 1)
                ]),
                    ...
                    createVNode("div", { class: "grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6" }, [
                      ...
                      createVNode("div", { class: "sm:col-span-6" }, [
                        ...
                        createVNode("div", { class: "mt-2 flex items-center gap-x-4" }, [
                          ...
                          }, null, 8, ["src"])) : __props.service.image ? (openBlock(), createBlock("img", {
                            key: 1,
                            src: `/storage/${__props.service.image}`,
                            alt: "Current Image",
                            class: "h-16 w-16 object-cover rounded-md shadow-sm"
