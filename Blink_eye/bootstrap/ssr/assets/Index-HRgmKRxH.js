...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Services Management" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="sm:flex sm:items-center"${_scopeId}><div class="sm:flex-auto"${_scopeId}><h1 class="text-base font-semibold leading-6 text-gray-900"${_scopeId}>Hospital Services</h1><p class="mt-2 text-sm text-gray-700"${_scopeId}>Manage the clinical services and treatment options offered by Blink Eye Hospitals.</p></div><div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              columns,
              data: __props.services.data,
              actionLabel: "Edit",
              actionRoute: (item) => _ctx.route("admin.services.edit", item.id)
            }, {
            ...
            if (__props.services.links && __props.services.links.length > 3) {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                href: __props.services.prev_page_url || "#",
                class: ["relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 mb-3", { "opacity-50 pointer-events-none": !__props.services.prev_page_url }]
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Previous`);
              ...
              _push2(ssrRenderComponent(unref(Link), {
                href: __props.services.next_page_url || "#",
                class: ["relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 mb-3", { "opacity-50 pointer-events-none": !__props.services.next_page_url }]
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Next`);
            ...
            return [
              createVNode("div", { class: "sm:flex sm:items-center" }, [
                createVNode("div", { class: "sm:flex-auto" }, [
                  createVNode("h1", { class: "text-base font-semibold leading-6 text-gray-900" }, "Hospital Services"),
                  createVNode("p", { class: "mt-2 text-sm text-gray-700" }, "Manage the clinical services and treatment options offered by Blink Eye Hospitals.")
                ]),
              ...
              createVNode("div", { class: "mt-8 flow-root" }, [
                ...
                __props.services.links && __props.services.links.length > 3 ? (openBlock(), createBlock("div", {
                  key: 0,
